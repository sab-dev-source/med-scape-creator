        ...
        <div className="text-center space-y-8">
          ...
          >
            <Link to="/upload-resume">
              <Button 
                size="lg" 
                className="bg-white text-slate-900 hover:bg-gray-100 px-8 py-4 text-lg font-semibold shadow-xl rounded-xl min-w-[240px] h-14 transition-all duration-300 hover:scale-105"
              >
            ...
            <Link to="/jobs">
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-white/30 bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm px-8 py-4 text-lg font-semibold rounded-xl min-w-[240px] h-14 transition-all duration-300 hover:scale-105"
              >
          ...
          >
            <div className="bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl">
              ...
              <Link to="/voice-bot">
                <Button 
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 font-semibold rounded-xl transition-all duration-300 hover:scale-105"
                >
